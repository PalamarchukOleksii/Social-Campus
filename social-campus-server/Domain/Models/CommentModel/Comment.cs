...
public class Comment
{
    ...
    public CommentId Id { get; private set; } = new(Guid.Empty);
    public string Description { get; private set; } = string.Empty;
    public DateTime CreationDateTime { get; private set; }
    public UserId CreatorId { get; private set; } = new(Guid.Empty);
    public virtual User? Creator { get; }
    public PublicationId RelatedPublicationId { get; private set; } = new(Guid.Empty);
    public virtual Publication? RelatedPublication { get; }
    public CommentId ReplyToCommentId { get; private set; } = new(Guid.Empty);
